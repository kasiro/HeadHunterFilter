...
### P1 (High)
- Страница настроек с экспортом/импортом конфигурации
...
- [ ] Тёма сохраняется между сессиями
- [ ] Ключевые слова применяются к названию и описанию
- [ ] Группы вакансий корректно приоритизируются
- [ ] Settings page позволяет экспортировать/импортировать настройки
