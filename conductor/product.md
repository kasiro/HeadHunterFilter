...
## Acceptance Criteria
- [ ] Фильтрация работает без перезагрузки страницы ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
- [ ] Тёма сохраняется между сессиями ⏳ **ТРЕБУЕТ ПРОВЕРКИ** (пользователь сообщил что не работает)
- [ ] Ключевые слова применяются к названию и описанию ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
- [ ] Группы вакансий корректно приоритизируются ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
- [ ] Settings page позволяет экспортировать/импортировать настройки ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
- [ ] Дизайн исключённых слов (выпадающий список) ⏳ **ТРЕБУЕТ ПРОВЕРКИ** (пользователь сообщил что сломан)
- [ ] Дизайн групп исключений с hover preview ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
- [ ] Цвет названия вакансии до наведения ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
- [ ] Tooltip не задваивается ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
- [ ] SASS warnings исправлены ⏳ **ТРЕБУЕТ ПРОВЕРКИ**
